...
void initializeApplication(void)
{
	...
	// std::cout << robotThreads.size() << std::endl;
...
void OutputFile(vector<Command> instructions, RobotInfo robot){
    ...
    switch (instructions[i].dir) {
        case NORTH:
            if (instructions[i].type == MOVE) {
                records << "Robot " << robot.index << " move N " << endl;
            } else if (instructions[i].type == PUSH) {
                records << "Robot " << robot.index << " push N " << endl;
            }
            break;
        case SOUTH:
            if (instructions[i].type == MOVE) {
                records << "Robot " << robot.index << " move S " << endl;
            } else if (instructions[i].type == PUSH) {
                records << "Robot " << robot.index << " push S " << endl;
            }
            break;
        case WEST:
            if (instructions[i].type == MOVE) {
                records << "Robot " << robot.index << " move W " << endl;
            } else if (instructions[i].type == PUSH) {
                records << "Robot " << robot.index << " push W " << endl;
            }
            break;
        case EAST:
            if (instructions[i].type == MOVE) {
                records << "Robot " << robot.index << " move E " << endl;
            } else if (instructions[i].type == PUSH) {
                records << "Robot " << robot.index << " push E " << endl;
            }
            break;
        default:
...
void robotThreadFunc(RobotInfo robot)
{
	...
	OutputFile(orders,robot); // creates the outputfile with all the directions
