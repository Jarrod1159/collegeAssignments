...
//  Edited by Jarrod Blanchette during Spring 2023 Semester
#include <iostream>
...
void myKeyboard(unsigned char c, int x, int y)
{
	...
	switch (c)
	{
		...
		case ' ':
			resetGrid();
			break;
//JYH does this make any sense for the increasing and decreasing the simulation speed?
		//	'+' --> increase simulation speed
		case '+':
			
			break;
			// increase the usleep time??
...
void myTimerFunc(int value)
{
    ...
    // threadFuncv1(nullptr);
    
    //jyh
    //	In V1, you need to call this function or nothing happens.
    //	Of course, this means that the function's prototype should be either in glFrontEnd.h
    //	or in this source file. 
	oneGenerationV1();
