...
//jyh
//	OK, at this point, I am confused about what you are trying to do, and it looks like
//	you are confused to0.
//	When I see
//void oneGenerationV1(unsigned int startrow, unsigned int endrow)
//										^                     ^
//										|                     |
//	This concerns a single thread  -----+---------------------+
//	Only a single thread works on a range of rows.
...
void oneGenerationV1(void)
{
	...
	for (int k = 0; k < numThreads; k++)
	{
		...
		int errCode = pthread_create(&info[k].threadID, nullptr, threadFuncV1, info + k);
		numLiveThreads++;
		displayStatePane();//static int generation = 0;
		if (errCode != 0)
		{
...
//jyh
//	Now is the time to do it because you know that all the computations for the current 
